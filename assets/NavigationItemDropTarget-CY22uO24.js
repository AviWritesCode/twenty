import{hz as l,fV as g,g4 as m,mj as f,g5 as s,fR as I,fS as b}from"./index-CXr1PeGK.js";import{g as v,c as S}from"./getDndKitDropTargetId-C_SrOpcs.js";import{N as _,A as x}from"./AddToNavSourceDroppableId-B_FsfYYE.js";import{N as O}from"./openNavigationMenuItemFolderIdsState-BDjnGp2j.js";const T=()=>({$empty:r})=>r?`min-height: ${s.spacing[2]};`:"",$=m("div")({name:"StyledSlotWrapper",class:"s4u41xg",propsAsIs:!1,vars:{"s4u41xg-0":[T()]}}),N=1,P=4,j=({droppableId:r,index:o,children:t,disabled:e=!1,collisionPriority:a=N})=>{const n=v(r,o),i={droppableId:r,index:o},{ref:p}=l({id:n,disabled:e,collisionPriority:a,collisionDetector:f,data:i}),d=t==null||Array.isArray(t)&&t.length===0;return g.jsx($,{ref:p,$empty:d,children:t})},F=r=>{const{sourceDroppableId:o}=I.useContext(_);return b(o)?o===x?!r:S({navigationMenuItemSection:"workspace",droppableId:o})!==r:!1},R=()=>({$compact:r})=>r?0:s.spacing[2],y=()=>({$highlightPosition:r})=>r==="top"?`
      top: 0;
